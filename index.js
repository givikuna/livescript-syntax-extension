...
(function(){
  var readlineSync, fs, path, _, ref$, filter, empty, floor, isItNaN, flatten, any, ONCE, nothing, NOTHING, isMoreThan, isLessThan, isNoMoreThan, isNoLessThan, readFile, readDir, exists, title, echo;
