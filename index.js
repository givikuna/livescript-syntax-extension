...
(function(){
  var readlineSync, fs, path, ref$, filter, empty, floor, isItNaN, flatten, dir, currentDir, len, print, isNumeric, haveMatchingValues, hasMatchingValuesWith, doesNotHaveMatchingValuesWith, occurs, occursIn, countOccurances, countOccurancesIn, occursMoreThan, occursLessThan, lower, upper, ONCE, nothing, NOTHING, moreThan, lessThan, isMoreThan, isLessThan, noMoreThan, noLessThan, isNoMoreThan, isNoLessThan, supertrim, stringToNumber, int, isJSON, isArray, equals, equalsAny, isNotBlank, isBlank, bool, booleanToString, boolString, str, random, scrambleArray, input, readFile, readDir, isFile, isDir, exists, readDirectories, readFiles, countDirectories, countFiles, strToTitle, title, roundToXDigits, toDecimal, toBinary, toHex, transpose, chunk;
