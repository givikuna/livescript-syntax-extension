...
(function(){
  var ref$, tail, fold, foldr, flip, foldl, filter, execSync, mapcar, str, int, random, lower, upper, inc, dec, supertrim, freq, len, enumerate, member, stringAppend, append, map2, listRef, hashRef, buildList, title, uniq, memoize, sorted, noop, id, before, after, throttle, debounce, lazy, listTo, listTil, bool, pipe, cond, expt, replaceAll, removeAll, iter, say, indexOf, isNumeric, csc, sec, cot, arcsin, arccos, arctan, arccsc, arcsec, expm1, replace, trimStart, trimEnd, input, charcode, makeHash, fold0, foldl0, foldr0, transpose, chunk, sleep, makeLegalJSName, lambda, fn, exec, toDeg, toRad, E, G, g, factorial, palindrome, divisors, perfect, toString$ = {}.toString, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
  ref$ = require('prelude-ls'), tail = ref$.tail, fold = ref$.fold, foldr = ref$.foldr, flip = ref$.flip, foldl = ref$.foldl, filter = ref$.filter;
  ...
  perfect = function(n){
    return n === foldl0(curry$(function(x$, y$){
      return x$ + y$;
    }), divisors(n));
  };
  module.exports = {
