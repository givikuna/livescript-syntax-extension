...
(function(){
  var ref$, tail, fold, foldr, flip, foldl, filter, map, execSync, mathjs, mapcar, str, int, random, lower, upper, inc, dec, supertrim, freq, len, enumerate, member, mem, stringAppend, map2, listRef, hashRef, buildList, title, uniq, memoize, sorted, noop, id, before, after, throttle, debounce, lazy, listTo, listTil, bool, pipe, cond, expt, replaceAll, removeAll, iter, say, indexOf, isNumeric, csc, sec, cot, arcsin, arccos, arctan, arccsc, arcsec, expm1, replace, trimStart, trimEnd, input, charcode, makeHash, fold0, foldl0, foldr0, transpose, chunk, sleep, makeLegalJSName, lambda, fn, exec, toDeg, toRad, E, G, g, factorial, palindrome, divisors, perfect, naturalNumber, isInt, changeIn, foldstr, foldt, foldf, summation, comb, invertMatrix, addMatrix, minusMatrix, multiplyMatrix, divideMatrix, chargePerElectron, chargePerProton, coulomb, microCoulumb, C, explode, implode, put, toString$ = {}.toString, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
  ...
  chargePerElectron = E(1.602176634, -19);
  chargePerProton = E(1.602176634, -19);
  coulomb = 1 / E(1.602176634, -19);
  microCoulumb = E(1, -6) * coulomb;
  C = 299792458;
  explode = function(it){
    return it.split('');
  };
  ...
  put = curry$(function(x, xs){
    return arrayFrom$(xs).concat([x]);
  });
  module.exports = {
    implode: implode,
    mem: mem,
    ...
    explode: explode,
    C: C,
    chargePerElectron: chargePerElectron,
    chargePerProton: chargePerProton,
    coulomb: coulomb,
    microCoulumb: microCoulumb,
    addMatrix: addMatrix,
