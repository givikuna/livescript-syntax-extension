...
(function(){
  var ref$, tail, fold, foldr, flip, foldl, filter, map, mathjs, mapcar, str, int, random, lower, upper, inc, dec, supertrim, freq, len, enumerate, member, mem, map2, stringAppend, listRef, hashRef, buildList, title, uniq, memoize, sorted, noop, id, before, after, throttle, debounce, lazy, listTo, listTil, bool, pipe, cond, expt, replaceAll, removeAll, iter, say, indexOf, isNumeric, replace, expm1, trimStart, trimEnd, charcode, makeHash, fold0, foldl0, foldr0, transpose, chunk, sleep, lambda, fn, λ, palindrome, foldstr, changeIn, Δ, foldt, foldf, factorial, comb, nCr, sin, cos, tan, csc, sec, cot, arcsin, arccos, arctan, arccsc, arcsec, toRad, toDeg, dsin, dcos, dtan, dcsc, dsec, dcot, darcsin, darccos, darctan, darccsc, darcsec, darccot, ln, recip, log10, log1p, log2, log, even, odd, E, G, earthMass, earthRadius, ge, gn, g, isNaturalNumber, isInt, summation, Σ, invertMatrix, addMatrix, subtractMatrix, multiplyMatrix, divideMatrix, elementaryCharge, e, C, π, pi, τ, tau, magneticConstant, μ0, vacuumPermittivity, ε0, Ke, electronMass, protonMass, me, mp, mα, alphaParticleMass, Qα, alphaParticleCharge, abs, floor, ceil, sqrt, cbrt, gcd, lcm, makeLegalJSName, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
